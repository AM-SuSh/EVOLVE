...
本目录存放各 Lab 的**配套答案**，与实验指导中的【任务二：阅读理解与思考题（必做）】一一对应。

| 答案文件 | 对应实验指导 |
|----------|----------------|
| [lab1-answers.md](lab1-answers.md) | [lab1-bare-metal.md](../lab1-bare-metal.md) |
| [lab2-answers.md](lab2-answers.md) | [lab2-trap-and-task.md](../lab2-trap-and-task.md) |
...
每个 `labN-answers.md` 固定三节：

1. **完整代码逐行解读** — 帮助对照仓库源码理解实现。
2. **任务二：阅读理解与思考题参考答案** — 对应实验文档【任务二】各题。
3. **任务三动手修改的现象参考** — 选做修改的预期现象说明。

## 使用建议

先独立完成实验文档中的【任务二】，再打开对应答案文件核对。不要先翻答案再读题。
