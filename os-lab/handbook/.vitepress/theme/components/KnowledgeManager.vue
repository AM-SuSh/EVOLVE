...
.icon-button { width: 34px; padding: 0; }.primary-button { border-color: var(--vp-c-brand-1); background: var(--vp-c-brand-1); color: var(--ws-accent-contrast); }.danger-button { color: var(--vp-c-danger-1); }.save-button { width: 100%; margin-top: 10px; }.button-row button:disabled,button:disabled { opacity: .5; cursor: not-allowed; }
...
.form-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 10px; }.form-grid label,.review-panel > label,.upload-dialog > label { display: flex; flex-direction: column; gap: 5px; color: var(--vp-c-text-3); font-size: 10px; } select,input[type="text"],textarea { min-height: 32px; padding: 6px 8px; border: 1px solid var(--vp-c-divider); border-radius: 5px; outline: 0; background-color: var(--vp-c-bg-soft); color: var(--vp-c-text-1); font-size: 12px; } textarea { resize: vertical; }.check-line { margin: 10px 0; }.button-row { flex-wrap: wrap; margin-top: 10px; }
