...
## 1. 赛题主线对照
 ...
 赛题要求 | 主入口 |
| --- | --- |
| 参考环境 5 章 **练习（exercise）** + 练习实现总结报告 | [reference-practice-report.md](reference-practice-report.md) |
...
| 组件单元测试（host） | **24/24** 通过 | [os-lab_verify.md §11](os-lab_verify.md) |
| clippy 全绿 | workspace + lab1–lab5 feature | [os-lab_verify.md §11](os-lab_verify.md) |
...
| [docs/os-lab_verify.md](os-lab_verify.md) | 自研环境验证与复现说明 |
| [docs/reference-practice-report.md](reference-practice-report.md) | 参考练习实现总结 |
...
按 [os-lab_verify.md §11](os-lab_verify.md) 完整验证块执行：workspace 编译、clippy、24 项单元测试、lab5→lab1 QEMU 倒序回归。
