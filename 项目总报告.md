...
> 补充材料：自研环境的完整设计总结见 `os-lab/docs/design-report.md`；feature gate、crate 边界和 Lab 数据流见 `os-lab/docs/architecture.md`；三方对比和学习效率评估见 `os-lab/docs/comparison.md` 与 `os-lab/docs/comparison-data.md`；学生侧 AI 协作模板和样例见 `os-lab/docs/ai-collaboration.md`。
...
> 补充材料：参考练习 base/exercise 逐章验收与复现命令见 `docs/reference-report.md`；自研环境完整验证步骤见 `docs/os-lab.md` 和 `os-lab/tests/README.md`；三方对比原始统计口径见 `os-lab/docs/comparison-data.md`。
